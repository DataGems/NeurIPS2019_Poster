...
\title{Nash Equilibria in Generative Adversarial Networks}
\author{David F.~Pepper}

\institute{\textsuperscript{$\dagger$}Department of AI Research, Paradox Labs}
\titlegraphic{\includegraphics[width=0.1\textwidth]{Pardox.jpg}}
...
\begin{columns}
    \column{0.32}
    \block{}{
         The Youtube voiceover can be found at \href{Your Youtube link here}{here}.
    }
